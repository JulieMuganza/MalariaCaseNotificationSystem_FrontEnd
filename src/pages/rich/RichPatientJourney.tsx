...
import { ChevronLeftIcon, UserIcon, MapPinIcon, ClockIcon } from 'lucide-react';
...
import { useSurveillanceBasePath } from './useSurveillanceBasePath';

export function RichPatientJourney() {
  ...
  const patientCode = patientCodeParam ? decodeURIComponent(patientCodeParam) : '';
    ...
    <div className={hcPage.wrap}>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-3 xl:items-start">
        <div className="space-y-4 xl:col-span-1">
          ...
          <PatientJourneyTimeline c={c} accent="blue" />
        </div>
