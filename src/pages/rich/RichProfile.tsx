    ...
    <div className="w-full max-w-[1240px] mx-auto space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="mt-1 text-sm font-medium text-gray-400">
          {partnerLabel} Surveillance · {user?.district ?? '—'}
        </p>
      </div>

      <div className="rounded-2xl border border-[color:var(--role-accent)]/20 bg-white p-8 shadow-sm">
